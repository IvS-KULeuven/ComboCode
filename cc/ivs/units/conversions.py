...
an import statement C{from cc.ivs.units import constants} is made. It will B{not}
change the values in modules where the import is done via
C{from cc.ivs.units.constants import *}. If you want to get the value of a
...
from cc.ivs.units.uncertainties import unumpy,AffineScalarFunc,ufloat
from cc.ivs.units.uncertainties.unumpy import log10,log,exp,sqrt
from cc.ivs.units.uncertainties.unumpy import sin,cos,tan
from cc.ivs.units.uncertainties.unumpy import arcsin,arccos,arctan
