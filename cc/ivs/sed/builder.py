...
You best B{switch on the logger} (see L{cc.ivs.aux.loggers.get_basic_logger}) to see the progress:
...
The content of the .phot file is most easily read using the L{cc.ivs.io.ascii.read2recarray}
...
To change the grid, load the L{cc.ivs.sed.model} module and call
L{cc.ivs.sed.model.set_defaults} with appropriate arguments. See that module for
...
from cc.ivs.aux import numpy_ext
from cc.ivs.aux import termtools
from cc.ivs.aux.decorators import memoized,clear_memoization
from cc.ivs.io import ascii
from cc.ivs.io import fits
from cc.ivs.io import hdf5
from cc.ivs.sed import model
from cc.ivs.sed import filters
from cc.ivs.sed import fit
from cc.ivs.sed import distance
from cc.ivs.sed import extinctionmodels
from cc.ivs.sed.decorators import standalone_figure
from cc.ivs.tools import spectra_combine
from cc.ivs.catalogs import crossmatch
from cc.ivs.catalogs import vizier
from cc.ivs.catalogs import mast
from cc.ivs.catalogs import sesame
from cc.ivs.catalogs import corot
from cc.ivs.units import conversions
from cc.ivs.units import constants
from cc.ivs.units.uncertainties import unumpy,ufloat
from cc.ivs.units.uncertainties.unumpy import sqrt as usqrt
from cc.ivs.units.uncertainties.unumpy import tan as utan
from cc.ivs.sigproc import evaluate
# try:
...
# 
    ...
    def plot_MW_side(self):
        ...
        fn_im = os.path.join(cc.path.ivsdata,'images','NRmilkyway.tif')
        im = image.open(fn_im)
    ...
    def plot_MW_top(self):
        ...
        fn_im = os.path.join(cc.path.ivsdata,'images','topmilkyway.jpg')
        im = image.open(fn_im)
